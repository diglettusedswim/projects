...
{
    public partial class disk_inventorykkContext : DbContext
    {
        public disk_inventorykkContext()
        {
        }

        public disk_inventorykkContext(DbContextOptions<disk_inventorykkContext> options)
            : base(options)
        {
        }
...
//#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                //optionsBuilder.UseSqlServer("Server=.\\SQLDEV01;Database=disk_inventorykk;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<DiskHasArtist>(entity =>
            {
                entity.HasKey(e => new { e.DiskId, e.ArtistId })
                    .HasName("PK__disk_has__2DAE42F07325A7E2");
            ...
            modelBuilder.Entity<DiskHasBorrower>(entity =>
            {
                ...
                entity.Property(e => e.BorrowerDate)
                    .HasColumnName("borrower_date")
                    .HasColumnType("date");
